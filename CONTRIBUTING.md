 ...
 * If necessary (e.g. due to 3rd party dependency licensing requirements), update the [NOTICE file](https://github.com/symphonyoss/bot-unfurl/blob/master/NOTICE) with any new attribution notices
