...
if [[ $BRANCH_NAME =~ master ]]; then
    ...
    export OC_BUILD_CONFIG_NAME="botunfurl-prod"
    ...
    export OC_BUILD_CONFIG_NAME="botunfurl-dev"
    export OC_PROJECT_NAME="ssf-dev"
fi

export OC_BINARY_FOLDER="./target/oc"
export OC_ENDPOINT="https://api.pro-us-east-1.openshift.com"
export OC_TEMPLATE_PROCESS_ARGS="-p BOT_NAME=$OC_BUILD_CONFIG_NAME -p SYMPHONY_POD_HOST=$SYMPHONY_POD_HOST -p SYMPHONY_API_HOST=$SYMPHONY_API_HOST"
